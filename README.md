...
The following instructions describe how to train a model using reward scripts and/or weights provided in [our latest release](https://github.com/umd-xlab/mario-kart/releases/tag/v1.0.0). 
...
> **Note:** Pre-verification and post-verification models are available in [our latest release](https://github.com/umd-xlab/mario-kart/releases/tag/v1.0.0).
